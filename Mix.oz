  ...
  %Mute
   ...
   /*fun {Echo Delay Decay Repeat Music P2T}
      ...
      in
         ...
         PaddedOriginal = {Append Original {Build (TotalLength - OriginalLen) 0.0}}
         ...
         for I in 1..Repeat do
            ...
            DelayedList = {Append {Build Delayed 0.0} NewList}
            Padded = {Append DelayedList {Build (TotalLength - {Length DelayedList}) 0.0}}
